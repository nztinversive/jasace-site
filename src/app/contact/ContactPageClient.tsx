...
export default function ContactPageClient() {
  if (!convexEnabled) {
    return <ContactPageContent settings={fallbackContent.siteSettings} />;
  }

  return <ConvexContactPageClient />;
}

function ConvexContactPageClient() {
...
function ContactPageContent({ settings }: { settings: SiteSettings }) {
  return (
    <main>
            ...
            <div className="lg:col-span-5 space-y-10">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-stone-500">{settings.email}</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-stone-500">{settings.phone}</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="border border-stone-700/50 p-6 bg-stone-800/30">
                  <div className="text-sm font-semibold text-stone-200">{settings.companyName}</div>
                  <div className="text-sm text-stone-500 mt-1">{settings.address}</div>
