...
const sections = [
  {
    ...
    content: "By accessing and using the Jasace ACE website (jasace.com), you accept and agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our website. We reserve the right to modify these terms at any time, and such modifications shall be effective immediately upon posting.",
  },
  {
    title: "Services Description",
    content: "Jasace ACE provides architecture, construction management, and engineering consulting services. Information on our website is intended for general informational purposes and does not constitute professional advice. Project-specific recommendations require formal engagement and are subject to separate contractual agreements.",
  },
  {
    title: "Intellectual Property",
    content: "All content on this website, including text, graphics, logos, images, photographs, and software, is the property of Jasace ACE or its content suppliers and is protected by United States and international copyright laws. The compilation of all content on this site is the exclusive property of Jasace ACE. You may not reproduce, distribute, or create derivative works from any content without our express written permission.",
  },
  {
    title: "Project Imagery",
    content: "Photographs and renderings of projects displayed on our website are the property of Jasace ACE unless otherwise credited. These images are provided for portfolio and informational purposes and may not be reproduced without permission. Some images may depict projects completed in collaboration with other firms, and credit is noted where applicable.",
  },
  {
    title: "Limitation of Liability",
    content: "Jasace ACE shall not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use our website or services, even if we have been advised of the possibility of such damages. This limitation applies to damages arising from the use of or reliance on information provided on our website, the cost of substitute services, or any other matter relating to our website.",
  },
  {
      ...
      <main className="pt-32 pb-20 bg-stone-950">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-stone-400 leading-relaxed mb-10">
            These Terms of Service govern your use of the Jasace ACE website and services.
