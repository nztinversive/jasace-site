              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    className="w-8 h-8 border border-stone-200 flex items-center justify-center text-stone-400 hover:text-terra hover:border-terra/30 transition-colors"
          ...
          <section className="py-16 lg:py-20 bg-stone-100 border-t border-stone-200">
            <div className="max-w-3xl mx-auto px-6 lg:px-8">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {related.map((rp) => (
                  <Link key={rp.slug} href={`/blog/${rp.slug}`} className="group bg-white border border-stone-200 overflow-hidden hover:border-terra/30 transition-colors">
